  ...
  return (
    <AnimatePresence>
      {!isChatOpen && (
        ...
        >
          {/* The Tab/Pill */}
          <div className="bg-[#0a0a0a]/95 backdrop-blur-xl border-r border-t border-b border-white/10 shadow-2xl rounded-r-md py-14 px-2 flex flex-col items-center gap-8 transition-all duration-300 group-hover:border-green-500/50 group-hover:bg-black group-hover:pr-3">
            {/* Icon */}
            <div className="relative transform rotate-0">
              ...
              <svg
                viewBox="0 0 24 24"
                className="w-5 h-5 text-white/90 group-hover:text-green-500 transition-colors relative z-10"
                fill="currentColor"
              >
            ...
            {/* Vertical Text */}
            <span className="text-[12px] text-white/80 font-medium tracking-[0.3em] uppercase [writing-mode:vertical-rl] rotate-180 group-hover:text-white transition-colors whitespace-nowrap">
              WhatsApp
            </span>
          </div>
        </motion.button>
