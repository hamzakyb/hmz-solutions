  ...
  return (
    <AnimatePresence>
      {!isChatOpen && (
        ...
        >
          {/* The Tab/Pill */}
          <div className="bg-[#0a0a0a]/95 backdrop-blur-xl border-r border-t border-b border-white/10 shadow-2xl rounded-r-lg py-10 px-1.5 flex flex-col items-center gap-6 transition-all duration-300 group-hover:border-green-500/50 group-hover:bg-black group-hover:pr-2.5">
            {/* Icon */}
            ...
            {/* Vertical Text */}
            <span className="text-[11px] text-white/80 font-medium tracking-[0.3em] uppercase writing-vertical-rl group-hover:text-white transition-colors whitespace-nowrap">
              WhatsApp
            </span>
          </div>
        </motion.button>
