  ...
  return (
    <section id="services" className="py-24 sm:py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-blue-50 rounded-full blur-3xl opacity-30" />
        <div className="absolute top-[20%] -right-[10%] w-[30%] h-[30%] bg-purple-50 rounded-full blur-3xl opacity-30" />
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <motion.span
              ...
              viewport={{ once: true }}
              className="inline-block px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold tracking-widest uppercase mb-4 border border-blue-100"
            >
              Hizmetlerimiz
            </motion.span>
            <motion.h2
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="mb-6 inline-flex p-3 rounded-xl bg-gray-50 text-gray-600 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                  ...
                  <div className="space-y-2 border-t border-gray-100 pt-6">
                    {service.features.map((feature: string, i: number) => (
                      <div key={i} className="flex items-center text-xs text-gray-500">
                        <ArrowRightIcon className="w-3 h-3 text-blue-400 mr-2 flex-shrink-0" />
