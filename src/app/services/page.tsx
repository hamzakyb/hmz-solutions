                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
                            Dijital <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Mükemmellik</span>
                        </h1>
                        <p className="text-xl text-gray-400 leading-relaxed font-light">
                            İşletmenizi geleceğe taşıyan, uçtan uca tasarlanmış teknoloji çözümleri.
                            Modern yazılım mimarileri ve ödüllü tasarım anlayışıyla fark yaratın.
                        </p>
                    </motion.div>
                </div>
            </section>
